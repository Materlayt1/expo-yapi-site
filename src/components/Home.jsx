...
const Home = () => {
    return (
        <div className='home'>
            ...
            <Fade>
                <div className="about">
                    <div className="p"> <h2>Expo Yapı Hakkında</h2></div>
            ...
            <Slide left> <Fade>
                ...
                <div className="project">
                    <div className="project-container">
                        <div className="icons"><Slide left> <Fade>
                            <h3>HİZMETLERİMİZ</h3>
            ...
            <div className="project-buildd mt-5 ">
                ...
                <div className="project-build-container">
                    ...
                    <a href="cesme-vilaları-proje" className='a'><div className="card ">
                        ...
                        <div className="card-hover"><a href="/cesme-vilaları-proje"><i class="fa-solid fa-plus"></i></a></div>
                    ...
                    <a href="kusadasi-vilaları-proje" className='a'><div className="card">
                        ...
                        <div className="card-hover"><a href="/kusadasi-vilaları-proje"><i class="fa-solid fa-plus"></i></a></div>
            ...
            <Slide left> <Fade> <div className="map"><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12504.351265966412!2d27.1987004!3d38.4163354!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14b9636f9aa098b7%3A0xc421a914705a2238!2sEXPO%20YAPI%20MARKET!5e0!3m2!1str!2str!4v1689001204477!5m2!1str!2str" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div> </Fade>  </Slide>
